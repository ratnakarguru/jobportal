...
# 2. NOTE: This route is currently accessible at GET /jobs/{user_id} 
# If you want it to be /dashboard/{user_id}, you should move this endpoint 
# into a separate dashboard router file.
@router.get("/{user_id}")
